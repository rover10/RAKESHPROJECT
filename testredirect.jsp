...
function funcontact(){
	...
	// $("#testdiv").load("<img src=http://localhost:8080/RAKESHPROJECT/load.gif>");
	document.getElementById("testdiv").innerHTML="<Center>Loading.... please wait !</Center>";
	document.getElementById("testdiv").style.visibility="visible";
	$(document).ready(function(){
		//document.getElementById("testdiv").innerHTML=( );
			//document.getElementById("testdiv").appendChild("<img src=load.gif>");     		
	...
	function funsignout(){
			...
			document.getElementById("mydummyform").submit();
	}
	
	function funlist(){
		 $(document).ready(function(){
			//alert("sending.....");
				$.post("http://localhost:8080/RAKESHPROJECT/myitems.jsp",
				{
				   user:"nothing"
				},
				function(data,status){
...
<body topmargin="0" leftmargin="0" rightmargin="0" onload="fundefault()">
<%-- START --%>
 ...
 <div ID="topbar">
	...
	<TR> 
		<TD>
		<form id="mydummyform" action="http://localhost:8080/RAKESHPROJECT/signout.jsp">
		
		<Table id="tblLogin" align="right" width="32%">
         <TR>
			<TD>
				<A href="#"> <font color="Yellow" size=4> Hi <U><% out.print(session.getAttribute("uEmail")); %></U></Font></A>
			
				&nbsp &nbsp 
				<font color="Yellow" size=4> <U><A href="#" onclick="funsignout()">Sign out</A></U></font>
			</TD>
			
		 </TR>
		 <tr><td><font color="Yellow" size=4><A href="#" onclick="funlist()"> Mylist</Font></td></tr>
		</Table>
		</form>	
		...
		&nbsp  &nbsp  &nbsp  &nbsp  &nbsp  &nbsp  &nbsp  &nbsp  &nbsp
		&nbsp  &nbsp  &nbsp  &nbsp  &nbsp  &nbsp  &nbsp  &nbsp  &nbsp 
		<A href="http://localhost:8080/RAKESHPROJECT/testredirect.jsp">
	...
	<TR>
		<TD><BR>
			...
			<a href="#home" onclick="funtrending()"> TRENDING NOW  </a>&nbsp &nbsp &nbsp &nbsp</li>
...
<br><br><br>
<center><div id="testdiv"  style="height:20px; width:50px left:30px" >
<img src="load.gif">
</div>
</center>
